...
struct MainMenuV2: View {
    var shapeSmalls: [String] = ["ConcreteSlab", "Round", "Segment", "Open Cylinder"]
    @State private var listView = false
    @State private var resetView = false
    @State var shapeSelected: String = ""
    @State var shapenotation: [String] = ["C", "R", "S", "O"]
    var body: some View {
        
        NavigationStack {
            List {
            ForEach(shapeSmalls, id: \.self) { shapeSmall in
                NavigationLink(destination: shapeSmallDetail(shapeSmall: shapeSmall, shapeSelected: $shapeSelected)) {
                    shapeSmallRow(shapeSelected: shapeSelected, shapeSmall: shapeSmall)
                               }
  // Use simultaeousGesture for Shapes
            .simultaneousGesture(TapGesture().onEnded {
             if let index = shapeSmalls.firstIndex(of: shapeSmall) {
               shapeSelected = shapenotation[index]
                                   }  /// If Let
                               }) /// .Simultabeous
                           } /// ForEach
                       } /// List
...
struct shapeSmallDetail: View {
    ...
    @Binding var shapeSelected: String
    
    func updateValuesShape() {
                ...
                if shapeSmall == "ConcreteSlab" {
                    HStack(spacing: 5) {
                        ...
                        TextField("", value: $Len, format: .number)
                            .onChange(of: Len) { updateValuesShape() }
                            .font(.largeTitle)
                    ...
                    GeometryReader { geometry in
                        HStack(spacing: 5) {
                            ...
                            TextField("", value: $Width, format: .number)
                                .onChange(of: Width) { updateValuesShape() }
                                .font(.largeTitle)
                                .foregroundColor(.black)
                    ...
                    GeometryReader { geometry in
                        HStack(spacing: 5) {
                            ...
                            TextField("", value: $Height, format: .number)
                                .onChange(of: Height) { updateValuesShape() }
                                .font(.largeTitle)
                                .foregroundColor(.black)
                                .frame(minWidth: 70, alignment: .leading)
                                .background(.orange)
                ...
                if shapeSmall == "Round" {
                    HStack(spacing: 5) {
                        ...
                        TextField("", value: $Diameter, format: .number)
                            .onChange(of: Diameter) { updateValuesShape() }
                            .font(.largeTitle)
                            .foregroundColor(.black)
                            .background(.orange)
                            .frame(minWidth: 70, alignment: .leading)
                ...
                if shapeSmall == "Open Cylinder" {
                    ...
                    HStack(spacing: 5) {
                        ...
                        TextField("", value: $DiameterIn, format: .number)
                            .onChange(of: DiameterIn) { updateValuesShape() }
                            .font(.largeTitle)
                            .foregroundColor(.black)
                            .background(.orange)
                            .frame(minWidth: 70, alignment: .leading)
